package com.myproject.tekit_kotlin_study.kotlin.Kotlin33_Enum

// 열거형
// 프로그램 개발 시 특정 그룹안의 구성 요소를 정의하는 값이 필요하고자 할 때 사용한다.
// 월을 나타내는 단어들, 형액형을 나타내는 단어들, 방향, 성별 등등등
...
// 하나에 대해 여러가지 값으로 표현할 수 있는 경우(예 : 원소기호 - 원소기호,이름,원소번호)에 사용한다
