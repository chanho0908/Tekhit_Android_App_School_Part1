...
// import를 이용해 사용하고자 하는 것을 명시해 주면
// 패키지명을 생략하고 사용할 수 있다.
// 아래의 코드는 이 파일에서 TestClass2를 사용하면
// kr.co.lion.pkg1에 있는 것임을 알려주는 것이다.

import com.myproject.tekit_kotlin_study.kotlin.Kotlin17_package.kr.co.lion.pkg1.TestClass2
import com.myproject.tekit_kotlin_study.kotlin.Kotlin17_package.kr.co.lion.pkg3.TestClass3
import com.myproject.tekit_kotlin_study.kotlin.Kotlin17_package.kr.co.lion.pkg3.TestClass4
...
// kr.co.lion.pkg3 에 있는 모든 클래스들은 패키지명을 생략하고 사용할 수 있다.
// 주의 : pkg3에 있는 클래스와 이름은 같지만 패키지가 다른 클래스를 import 하게되면
// 오류가 발생한다.
...
fun main(){
    ...
    var obj1 = com.myproject.tekit_kotlin_study.kotlin.Kotlin17_package.kr.co.lion.pkg1.TestClass1()
    ...
    // 패키지명을 생략할 수 없다.
    var obj22 = com.myproject.tekit_kotlin_study.kotlin.Kotlin17_package.kr.co.lion.pkg2.TestClass2()
