package com.myproject.tekit_kotlin_study.kotlin.Kotlin39_Function
...
// 매개변수로 들어는 값을 가지고 계산한다음 반환하는 함수의 코드가 여러줄일 경우
...
// 람다는 -> 다음에 나오는 코드 중에 제일 마지막에
// 작성한 수식의 결과를 반환한다.
// testFun3 과 같이 코드가 여러 줄인 것을 람다로
// 대체할 수 있다.
