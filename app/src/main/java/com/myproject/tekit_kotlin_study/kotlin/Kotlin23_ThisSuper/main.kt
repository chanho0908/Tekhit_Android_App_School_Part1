package com.myproject.tekit_kotlin_study.kotlin.Kotlin23_ThisSuper
// this : 객체 자기 자신을 가르킨다.
// 변수 : property(맴버 변수)를 지칭하는 용도로 사용한다.
// 생성자 : 다른 생성자를 호출하기 위해 사용한다.
// 메서드 : 맴버 메서드와 지역 메서드를 구분하기 위해 사용한다.

// super : 부모를 가르킨다.
// 변수 : 객체가 가지고 있는 property(변수)와 부모가 가지고 있는 property(변수)를 구분하기 위해 사용한다.
// 생성자 : 부모의 생성자를 호출하기 위해 사용한다.
// 메서드 : 자식에서 overrdiding한 메서드와 부모의 메서드를 구분하기 위해 사용한다.
...
class TestClass1{
    ...
    fun testMethod2(){
        ...
        // 클래스의 맴버 메서드와 동일한 메서드를 내부에 만들어준다.
        fun testMethod3(){
        ...
        // 메서드 내부에 만든 메서드 호출
        testMethod3()
        // 만약 맴버 매서드를 호출하고 싶다면 this를 이용하여 호출
        this.testMethod3()
    }
...
class SubClass1: SuperClass1{
    ...
    fun subMethod1(superValue1:Int){
        ...
        // 매개변수의 이름과 프로퍼티의 이름이 같이 때문에 프로퍼티에 접근하려면
        // this를 사용해 한다.
        // 만약 동일명의 매개변수가 없다면 this는 생략 가능하다.
        println("this.superValue1 : ${this.superValue1}")
        // 매개변수의 이름이나 맴버 프로퍼티의 이름이 부모의 프로퍼티 이름과 동일할 경우
    ...
    fun subMethod2(){
        superMethod2()
        // 부모의 메서드를 자식에서 재 구현한 경우 부모의 메서드를 호출하고자 한다면
        // super를 사용한다.
        super.superMethod2()
    }
}
