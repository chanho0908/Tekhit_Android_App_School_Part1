package com.myproject.tekit_kotlin_study.kotlin.Kotlin15_Contructor
...
// this : 객체가 가지고 있는 맴버를 지칭하기 위해 사용한다.
// 메서드나 생성자의 매개변수 이름과 객체의 맴버 변수의 이름이 같을 때 사용한다.
