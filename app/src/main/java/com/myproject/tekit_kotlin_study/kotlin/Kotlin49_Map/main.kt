package com.myproject.tekit_kotlin_study.kotlin.Kotlin49_Map
...
fun main(){
    ...
    // 이름은 문자열이 아니어도 가능
    val map2 = mapOf(10 to "문자열", 20 to "문자열2", 30 to "문자열3")
    println("map : $map2")
    ...
    // 제네릭 설정 가능
    // map은 제네릭을 설정하지 않아도 되지만 딱 한 경우에는 무조건 설정해야한다.

    // 한가지 타입의 객체를 담는 맵
    // <이름으로 사용할 객체의 클래스 타입, 저장할 객체의 클래스 타입>
    val map5 = mapOf<String, Int>("key1" to 10, "key2" to 20, "key" to 30)
    println("map5 : $map5")
    ...
    // 텅 비어 있는 맵을 만들때는 반드시 제네릭을 설정해야 한다.
